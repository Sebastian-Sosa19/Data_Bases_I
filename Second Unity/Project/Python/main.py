...
config = ConnectionConfig("localhost","3306","root","lockandgo","DBA")
...
engine.addUser("sebastian", "holis")
# engine.addUser("aloja", "holis")
# engine.addUser("sende", "holis")

# engine.dropUser("sebastian")

#engine.alterUser("sebastian", "sebas")